...
contract CPro {
    ...
    string public name = "CP Processor";
    // Set the symbol for display purposes
    string public symbol = "cPRO";
    ...
    /**
     * Sets allowance for other address and notifies
     *
    ...
    function burnFrom(address _from, uint256 _value) public returns (bool success) {
        // Checks if the targeted balance is enough
        require(balanceOf[_from] >= _value);
        // Checks allowance
        require(_value <= allowance[_from][msg.sender]);
        // Subtracts from the targeted balance
        balanceOf[_from] -= _value;
        // Subtracts from the sender's allowance
        allowance[_from][msg.sender] -= _value;
        // Updates totalSupply
        totalSupply -= _value;
        Burn(_from, _value);
